<template lang="">
  <div>
    <div class="bottom-box">
     ...
     <router-link tag="a" class="fill-box" :to="{path:'/tasklist/taskdetail/input_reminder', query:{lDebtorId:this.$route.query.lDebtorId,lEntrustId: detailData.lEntrustId,strDebtorName:detailData.strName}}">填写催记</router-link>
    </div>

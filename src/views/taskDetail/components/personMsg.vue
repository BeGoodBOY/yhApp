  ...
  <div class="person-box">
    <ul class="basic-msg">
      ...
      <li>
        ...
        <span class="right-box">{{personData.nSex == 0 ? '女' : '男'}}</span>
      </li>
      <li>
    ...
    <ul class="other-box">
      ...
      <li @click="toOtherConcact">
        <span class="left-box">其它信息</span>
        <span class="right-box"></span>
      </li>
      <li @click="toNewConcact" v-show="personData.nAddContactCount>0">
        <span class="left-box">新增信息</span>
        <span class="right-box"></span>
      </li>
      <li @click="toLawuit" v-show="personData.nIsLawsuit == 1">
      ...
      <li @click="toTargetInfo">
        <span class="left-box">目标值信息</span>
        <span class="right-box"></span>
      </li>
    </ul>
  </div>
...
export default {
  ...
  methods:{
    ...
    toClientAgree(){ //跳转委托协议
      this.$router.push({path:'/tasklist/taskdetail/clientAgreet',query:{id:this.id}})
    },
    ...
    toNewConcact(){
      this.$router.push({path:'/tasklist/taskdetail/newContact',query:{id:this.id}})
    },
    toTargetInfo(){
      this.$router.push({path:'/tasklist/taskdetail/targetInfo',query:{id:this.personData.lDebtPoolId}})
    }
  },
  beforeCreate() {
